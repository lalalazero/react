...
if (canUseDOM) {
  var JSCompiler_inline_result$jscomp$159;
  if (canUseDOM) {
    var isSupported$jscomp$inline_282 = "oninput" in document;
    if (!isSupported$jscomp$inline_282) {
      var element$jscomp$inline_283 = document.createElement("div");
      element$jscomp$inline_283.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_282 =
        "function" === typeof element$jscomp$inline_283.oninput;
    }
    JSCompiler_inline_result$jscomp$159 = isSupported$jscomp$inline_282;
  } else JSCompiler_inline_result$jscomp$159 = !1;
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$159 &&
...
for (
  var i$jscomp$inline_1294 = 0;
  i$jscomp$inline_1294 < otherDiscreteEvents.length;
  i$jscomp$inline_1294++
)
  eventPriorities.set(otherDiscreteEvents[i$jscomp$inline_1294], 0);
...
function commitWork(current, finishedWork) {
  switch (finishedWork.tag) {
        ...
        if (null !== updatePayload) {
          ...
          switch (current) {
            ...
            case "textarea":
              ...
              break;
            case "select":
              (finishedWork = updateQueue._wrapperState.wasMultiple),
                (updateQueue._wrapperState.wasMultiple = !!effect.multiple),
                (current = effect.value),
                null != current
                  ? updateOptions(updateQueue, !!effect.multiple, current, !1)
                  : finishedWork !== !!effect.multiple &&
    ...
    case 12:
      return;
    case 13:
      updateQueue = finishedWork.memoizedState;
      null !== updateQueue &&
        ((globalMostRecentFallbackTime = now()),
        hideOrUnhideAllChildren(finishedWork.child, !0));
      null !== updateQueue &&
        ((updateQueue = finishedWork.memoizedProps.suspenseCallback),
        "function" === typeof updateQueue &&
          ((effect = finishedWork.updateQueue),
          null !== effect && updateQueue(new Set(effect))));
        ...
        if (
          ...
          do {
            ...
            if (JSCompiler_temp) {
              ...
              workInProgress$111.flags |= 4096;
              workInProgress$111.lanes = thrownValue;
              break a;
            }
          ...
          switch (workInProgress$111.tag) {
            ...
            case 1:
              ...
              if (
                ...
                enqueueCapturedUpdate(workInProgress$111, update$115);
                break a;
              }
          }
          workInProgress$111 = workInProgress$111.return;
  ...
  if (null !== remainingLanes) {
    ...
    do
      try {
        ...
        if (null === nextEffect) throw Error(formatProdErrorMessage(330));
        captureCommitPhaseError(nextEffect, error$125);
        nextEffect = nextEffect.nextEffect;
      }
    while (null !== nextEffect);
    ...
    do
      try {
        ...
        if (null === nextEffect) throw Error(formatProdErrorMessage(330));
        captureCommitPhaseError(nextEffect, error$126);
        nextEffect = nextEffect.nextEffect;
      }
    while (null !== nextEffect);
    nextEffect = null;
    ...
    if (null !== spawnedWorkDuringRender)
      for (
        renderPriorityLevel = spawnedWorkDuringRender,
          spawnedWorkDuringRender = null,
          flags$jscomp$0 = 0;
        flags$jscomp$0 < renderPriorityLevel.length;
        flags$jscomp$0++
      )
        scheduleInteractions(
          root,
          renderPriorityLevel[flags$jscomp$0],
...
function flushPassiveEffectsImpl() {
  ...
  for (var i = 0; i < unmountEffects.length; i += 2) {
    var effect$131 = unmountEffects[i],
      fiber = unmountEffects[i + 1],
      destroy = effect$131.destroy;
    effect$131.destroy = void 0;
  ...
  for (i = 0; i < unmountEffects.length; i += 2) {
    effect$131 = unmountEffects[i];
    fiber = unmountEffects[i + 1];
    try {
      var create = effect$131.create;
      effect$131.destroy = create();
    } catch (error$135) {
      if (null === fiber) throw Error(formatProdErrorMessage(330));
      captureCommitPhaseError(fiber, error$135);
    }
  }
